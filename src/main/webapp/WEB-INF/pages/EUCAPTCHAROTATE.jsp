                ...
                <div class="panel panel-default bg border">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <button title="Use a slider" id="btnslider" class="btn btn-warning"><fmt:message
                                    key="euCaptcha.button.slider"/></button>
                            <button title="Use arrows" id="btnarrows" class="btn btn-warning"><fmt:message
                                    key="euCaptcha.button.arrows"/></button>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-8">
                                <button id="btnToLeft" class="btn btn-primary btn-lg"><fmt:message key="euCaptcha.turn"/> <i
                                        class="bi-arrow-counterclockwise" style="font-size:30px"></i></button>
                                <div class="captchaContainer">
                                    <img id="captchaImage" src="" alt="duck" width="200" height="200" captchaId="">
                                </div>
                                <button id="btnToRight" class="btn btn-primary btn-lg"><fmt:message key="euCaptcha.turn"/>
                                    <i class="bi bi-arrow-clockwise" style="font-size:30px"></i></button>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button title="Validate the Captcha" id="validateWhatsUpCaptcha" class="btn btn-success">
